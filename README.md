...
* `PRESERVED_DIRECTORIES` — список имён директорий, которые нужно сохранить, скопировав из директории с действующей инсталляцией в промежуточную директорию, разделённых пробелом.
* `PRESERVED_FILES` — список имён файлов, которые нужно сохранить, разделённых пробелом.
